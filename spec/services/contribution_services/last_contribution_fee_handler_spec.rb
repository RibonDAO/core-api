...
RSpec.describe ContributionServices::LastContributionFeeHandler, type: :service do
  subject(:service) do
  ...
  let(:remaining_fee_handler_service) do
    instance_double(ContributionServices::RemainingContributionFeeHandler)
  end
  let(:contribution_fee_creator_service) do
    instance_double(ContributionServices::ContributionFeeCreator)
  end

  describe '#charge_remaining_fee' do
    before do
      allow(ContributionServices::RemainingContributionFeeHandler)
        .to receive(:new).and_return(remaining_fee_handler_service)
      allow(ContributionServices::ContributionFeeCreator)
    ...
    it 'creates a contribution fee with the correct parameters' do
      ...
      expect(ContributionServices::ContributionFeeCreator)
    ...
    context 'when accumulated_fees_result is greater than fees_balance_cents' do
      ...
      it 'calls RemainingContributionFeeHandler to spread the remaining fee' do
        service.charge_remaining_fee
