...
RSpec.describe Contributions::LastContributionFeeHandlerService, type: :service do
  subject(:service) do
  ...
  let(:remaining_fee_handler_service) do
    instance_double(Contributions::RemainingContributionFeeHandlerService)
  end
  let(:contribution_fee_creator_service) do
    instance_double(Contributions::ContributionFeeCreatorService)
  end

  describe '#charge_remaining_fee' do
    before do
      allow(Contributions::RemainingContributionFeeHandlerService)
        .to receive(:new).and_return(remaining_fee_handler_service)
      allow(Contributions::ContributionFeeCreatorService)
    ...
    it 'creates a contribution fee with the correct parameters' do
      ...
      expect(Contributions::ContributionFeeCreatorService)
