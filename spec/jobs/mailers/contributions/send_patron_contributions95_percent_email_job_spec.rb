...
RSpec.describe Mailers::Contributions::SendPatronContributions95PercentEmailJob, type: :job do
  describe '#perform' do
    ...
    it 'logs the email' do
      ...
      expect(EmailLog).to have_received(:log).with(
        ...
        receiver: big_donor,
        sendgrid_template_name: 'patron_contributions_95_percent_email_template_id'
      )
    end
  end
end
