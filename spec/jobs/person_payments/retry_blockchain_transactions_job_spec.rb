...
RSpec.describe PersonPayments::RetryBlockchainTransactionsJob, type: :job do
  describe '#perform' do
    ...
    before do
      allow(PersonPayments::BlockchainTransactions::Cause::UpdateProcessingTransactions).to receive(:call)
    ...
    it 'calls the retries commands' do
      ...
      expect(PersonPayments::BlockchainTransactions::Cause::UpdateProcessingTransactions).to have_received(:call)
